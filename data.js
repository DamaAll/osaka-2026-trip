...
{time:'15:15–16:15',type:'shopping',title:'錦市場｜只逛一小時',desc:'伴手禮與零食抓重點，不逛完整條。河原町百貨留到有力氣再說。',note:'今天 9/23 同時是週三和秋分日：錦市場有些店週三公休、有些店祝日公休，可能比平常少開一些，觀光取向的店通常照開。禁止邊走邊吃，買了要在店門口吃完再走，垃圾交回原店。刻意壓成一小時，是為了 16:30 就能上車。',actions:[['📍 錦市場','https://www.google.com/maps/search/?api=1&query=Nishiki+Market+Kyoto','map']]},
...
{time:'進場後',type:'attraction',title:'一人代表抽全員的整理券',desc:'掃票入園後才抽得到。由一個人在 USJ App 登錄四張 Studio Pass，在「e整理券」一次抽四人份，才會拿到同一個時段。',status:'decision',statusLabel:'不要各抽各的',note:'四個人各自抽會拿到不同時段，等於把隊伍拆散——這是最常見的錯誤。2026 年起園內發券機已廢止，只能用 App。整理券抽完會自動轉成「抽選券」（抽籤，沒中就進不去）；沒中的話等傍晚人潮散掉再試，中午最擠不要硬闖。'},
...
{time:'閉園後',type:'hotel',title:'走回環球塔｜24:00 前入住',desc:'玩完直接休息，不回心齋橋。',note:'飯店 check-in 受理到深夜 24:00 為止，Horror Nights 玩到閉園也來得及，但不要在園區外閒晃到過午夜。回房後先秤行李，不要留到明天早上。'}]},
