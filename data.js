...
{key:'jiho',name:'聯邦吉鶴卡',best:'實際可疊到 7%',period:'2026/7/1–12/31',tone:'amber',rows:[
['打底','日幣消費 2.5%，無上限、免登錄'],
['已登錄①','海外加碼 3%，但只算單月一般消費「超過 NT$15,000 的部分」。月上限 1,000 元，每月限量 1,350 名'],
['已登錄②','日本行動支付 1.5%，需綁 Apple／Google Pay 感應、單筆滿 NT$100。月上限 600 元，排除網購與交通'],
['疊起來','刷不到 15,000 的部分是 2.5＋1.5＝4%；超過的部分才是 7%'],
['吃滿上限要多少','①當月約要刷到 NT$48,000；②約 NT$40,000。四個人分開刷比集中在一張好']],
tip:'官方兩份文件打架：活動條款寫「不適用 QUICPay」，但聯邦自己的 Apple Pay 說明又寫在日本會以 QUICPay 模式扣款、要你告知店員用 QUICPay。①的 3% 不受影響，但②的 1.5% 有可能因此拿不到——出發前打客服問清楚，別把行動支付當保證。',
url:'https://activity.ubot.com.tw/2026JiHoCard/japan.htm'}],
plan:[
['前 NT$6,250 刷 uniopen','這一段是 11%，全場最高，而且免登錄。刷滿就換卡。'],
['之後改刷吉鶴卡','2.5% 打底＋你登錄的行動支付 1.5% ＝ 4%，比 uniopen 用完加碼後的 3% 好。'],
['結帳一律選日幣','選台幣是 DCC，匯率明顯較差；而且吉鶴的 2.5% 是綁「日幣消費」才算。']],
warning:'吉鶴卡那個 NT$15,000 門檻，官方只寫「單月一般消費」，沒說清楚台灣國內消費算不算。算的話你們出國前可能就過門檻、在日本每一筆都有 3%；不算的話要在日本先刷滿 15,000 才開始。這題值得打客服問，答案會改變要刷哪張。'},
...
['手機 / 交通 / 付款',[
['esim','安裝 KKday eSIM','到日本才啟用旅遊 eSIM 行動數據。'],['iccard','確認每個人的交通卡方案','iPhone 開 Apple Wallet；Android 走實體 ICOCA。'],['cash','備好日幣現金＋信用卡','不要只帶單一付款方式，現金分開保管。'],['apps','下載 Google Maps / Translate / USJ App','先下載並登入，地圖下載離線版。'],['cardreg','打客服問吉鶴卡兩件事','①NT$15,000 門檻算不算台灣國內消費；②日本用 Apple Pay 走 QUICPay 還能不能拿 1.5%。兩題都會改變在日本要刷哪張卡。']]],
['USJ / 預約',[
