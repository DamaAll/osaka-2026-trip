...
{key:'myjapan',name:'MyJapan+ by JCB（要另外登錄）',best:'滿 ¥100,000 退 ¥10,000',period:'登錄與消費都到 2026/9/30',tone:'blue',rows:[
['這是誰的活動','JCB 自己辦的，跟聯邦那幾個各算各的，可以疊在同一筆消費上'],
['條件','日本境內實體店面、以日圓結算，累計滿 ¥100,000 回饋 ¥10,000。每卡限一次'],
['付款方式','實體卡、Apple Pay、Google Pay、QUICPay 都算——這裡 QUICPay 是可以的'],
['不算的','網購、非日圓結算、其他電子支付與第三方支付'],
['期限','9/30 截止，你們 9/21–25 剛好在期間內。但要「事前」登錄，出發前就要弄好'],
['名額','全期限 88,888 名，額滿為止']],
tip:'¥100,000 約當 NT$22,000，一個人自己刷不太到，但四個人的餐費加購物很容易超過。做法是四人消費先集中刷同一張已登錄的吉鶴卡，回台再用「花費」分頁分帳——這也是那個分帳表最實際的用途。',
url:'https://www.specialoffers.jcb/zh-tw/myjapan-app/cashback2026/'}],
plan:[
['先讓一張吉鶴卡刷滿 ¥100,000','MyJapan+ 退 ¥10,000 是全場最大一筆。四人的餐費與購物先集中在同一張，之後分帳。'],
['接下來 NT$6,250 刷 uniopen','這一段 11%，全場第二高，免登錄也不挑店。'],
['其餘還是吉鶴卡','2.5＋1.5 ＝ 4%，在 Donki、Bic Camera、超商、USJ 園內再＋3%。比 uniopen 用完加碼後的 3% 好。'],
['結帳一律選日幣','選台幣是 DCC，匯率明顯較差；而且吉鶴的 2.5% 與 MyJapan+ 都規定要以日圓結算才算。']],
warning:'順序會反直覺：不要為了 uniopen 的 11% 把消費拆開。拆了就湊不到 ¥100,000，等於用 NT$687 換掉 ¥10,000。先讓一張吉鶴卡過門檻，再談其他。另外吉鶴卡的 NT$15,000 門檻官方只寫「單月一般消費」，沒說台灣國內消費算不算，這題要問客服。'},
...
['手機 / 交通 / 付款',[
['esim','安裝 KKday eSIM','到日本才啟用旅遊 eSIM 行動數據。'],['iccard','確認每個人的交通卡方案','iPhone 開 Apple Wallet；Android 走實體 ICOCA。'],['cash','備好日幣現金＋信用卡','不要只帶單一付款方式，現金分開保管。'],['apps','下載 Google Maps / Translate / USJ App','先下載並登入，地圖下載離線版。'],['cardreg','打客服問吉鶴卡兩件事','①NT$15,000 門檻算不算台灣國內消費；②日本用 Apple Pay 走 QUICPay 還能不能拿 1.5%。兩題都會改變在日本要刷哪張卡。'],['myjapan','下載 MyJapan+ by JCB 並登錄滿額回饋','滿 ¥100,000 退 ¥10,000，必須事前登錄、9/30 截止、限量 88,888 名。這是全場最大一筆，別漏。'],['cardtransit','9/15 後登錄吉鶴卡交通卡儲值活動','儲值三大交通卡 1.5%，每月 15 日上午 10 點才開放、限量 10,000 名。路徑：限時登錄活動專區→其他平台。']]],
['USJ / 預約',[
