...
['11 大商店 3%','免登錄自動生效，但上限是「整個活動期間 600 元」，刷到約 NT$20,000 就滿了'],
...
['你實際疊得到','指定通路＋行動支付 ＝ 7%；其他店家 ＝ 4%。單月刷破 15,000 之後各再＋3%'],
['官網那個 11%／22%','都含「新戶加碼 3%」和 JCB APP 新用戶禮。你不是新戶，直接跳過這兩個數字']],
...
['手機 / 交通 / 付款',[
['esim','安裝 KKday eSIM','到日本才啟用旅遊 eSIM 行動數據。'],['iccard','確認每個人的交通卡方案','iPhone 開 Apple Wallet；Android 走實體 ICOCA。'],['cash','備好日幣現金＋信用卡','不要只帶單一付款方式，現金分開保管。'],['apps','下載 Google Maps / Translate / USJ App','先下載並登入，地圖下載離線版。'],['cardreg','打客服問吉鶴卡兩件事','①NT$15,000 門檻算不算台灣國內消費；②日本用 Apple Pay 走 QUICPay 還能不能拿 1.5%。兩題都會改變在日本要刷哪張卡。'],['cardtransit','9/15 後登錄吉鶴卡交通卡儲值活動','儲值三大交通卡 1.5%，每月 15 日上午 10 點才開放、限量 10,000 名。路徑：限時登錄活動專區→其他平台。']]],
['USJ / 預約',[
