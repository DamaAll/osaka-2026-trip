...
{key:'jiho',name:'聯邦吉鶴卡',best:'指定通路最高 11%',period:'2026/7/1–12/31',tone:'amber',rows:[
['怎麼算','日幣消費 2.5%（無上限）＋指定通路綁 Apple / Google Pay 加碼'],
['要登錄嗎','要，而且必須在「消費當月」登錄，用 MyJapan+ by JCB APP'],
['上限','每戶每月 1,000 元刷卡金，而且每月限量 1,350 名'],
['指定通路','7-11、全家、LAWSON、唐吉訶德、BIC CAMERA、大阪環球影城、高島屋、三越、AEON 等']],
tip:'限量 1,350 名是先到先得。9 月一開始就進 App 登錄，不要拖到出發前一天才弄。',
url:'https://activity.ubot.com.tw/aws_act/2026/20260607overseas/index.htm'}],
plan:[
['Donki、Bic Camera、USJ、超商','刷吉鶴卡，並且用 Apple Pay／Google Pay。這幾家都在指定通路名單上，而且你們行程一定會走到。'],
['其他所有店家','刷 uniopen。免登錄、不挑店，加碼吃到每月 500 點為止。'],
['結帳一律選日幣','店員問要用日幣還台幣結帳時選日幣（JPY）。選台幣是 DCC，匯率明顯較差。']],
warning:'指定通路名單各家整理略有出入，出發前請以 App 內公告為準。兩張卡的加碼都有月上限，四個人分開刷才吃得滿。'},
...
['手機 / 交通 / 付款',[
['esim','安裝 KKday eSIM','到日本才啟用旅遊 eSIM 行動數據。'],['iccard','確認每個人的交通卡方案','iPhone 開 Apple Wallet；Android 走實體 ICOCA。'],['cash','備好日幣現金＋信用卡','不要只帶單一付款方式，現金分開保管。'],['apps','下載 Google Maps / Translate / USJ App','先下載並登入，地圖下載離線版。'],['cardreg','在 MyJapan+ App 登錄吉鶴卡活動','每月限量 1,350 名、且須當月登錄。9 月一開始就登錄，晚了就沒名額。']]],
['USJ / 預約',[
